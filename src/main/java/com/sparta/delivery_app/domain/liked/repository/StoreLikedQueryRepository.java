...
public class StoreLikedQueryRepository {
    ...
    public Page<LikedWithUserVO> searchQueryLikedWithUserAndStoreByUser(User findUser,
            Pageable pageable) {
    ...
    public Page<LikedMenuWithUserDto> searchQueryLikedMenuWithUserAndStoreAndMenuByUser(
            User findUser, Store findStore, Pageable pageable) {
        ...
        List<LikedMenuWithUserDto> likedMenuWithUserDtos = Collections.singletonList(
                likedMenuWithUserDto);

        return PageableExecutionUtils.getPage(likedMenuWithUserDtos, pageable,
                countQuery::fetchOne);
    }
